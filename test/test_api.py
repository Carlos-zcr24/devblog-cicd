...
class TestAPIEndpoints:
    """
    Pruebas de los endpoints JSON de la API REST.
    Razones para probar la API por separado:
    - Diferentes tipos de respuesta (JSON vs HTML)
    - Casos de uso como apps móviles o integraciones
    - Validaciones y manejo de errores específicos
    """

    def test_get_all_posts_success(self, client):
        """
        Test: GET /api/posts devuelve todos los posts
        """
